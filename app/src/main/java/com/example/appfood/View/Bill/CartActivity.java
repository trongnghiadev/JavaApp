...
//Dien thong tin đặt hàng
    ...
    private void requestPayment() {
        ...
        eventValue.put("merchantname", "TNAFOOD"); //Tên đối tác. được đăng ký tại https://business.momo.vn. VD: Google, Apple, Tiki , CGV Cinemas
        ...
        eventValue.put("description", "Thanh toán tiền đồ ăn cho Trọng Nghĩa"); //mô tả đơn hàng - short description
